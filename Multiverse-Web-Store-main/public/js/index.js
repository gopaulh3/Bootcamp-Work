...
const homeContents = [
  {
    ...
    cp1: 'Shine bright like a',
    cp2: 'diamond',
    img: 'jewellerywomen',
    link: 'http://localhost:3000/category.html?id=2',
  },
  {
    ...
    cp2: 'ends',
    img: 'clothingwomen',
    link: 'http://localhost:3000/category.html?id=5',
  },
  {
    ...
    cp2: 'classic',
    img: 'jewellerymen',
    link: 'http://localhost:3000/category.html?id=3',
  },
  {
    ...
    cp2: 'accessories',
    img: 'headphones',
    link: 'http://localhost:3000/category.html?id=4',
  },
];
...
homeContents.forEach((result, idx) => {
  ...
  <div class="home-text">
    ...
    <a href="${
      result.link
    }" class="btn btn-shop">Shop now for ${result.category.toLowerCase()}</a>
  </div>
</div>
  `;
...
const contents2 = [
  { img: 'clothingmen2', btn: 'M', link: './category.html?id=1' },
  { img: 'clothingwomen3', btn: 'Wom', link: './category.html?id=5' },
];
...
const contents3 = [
  {
    img: 'jewellerywomen3',
    btn: 'Wom',
    link: './category.html?id=2',
  },
  { img: 'jewellerymen4', btn: 'M', link: './category.html?id=3' },
];
...
// Section 3 gridview for jewellery
const contents4 = [
  { img: 'phone', btn: 'Phones' },
  { img: 'headphones2', btn: 'Headphones' },
  { img: 'tv', btn: 'TVs' },
  { img: 'laptop', btn: 'Laptops' },
];
const container4 = document.getElementById('sw-electronics');
contents4.forEach((result, idx) => {
  const link = './category.html?id=4';
  const content = `
  <div class="box">
